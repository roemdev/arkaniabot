...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("roll")
    .setDescription(
      "Lanza un dado virtual con un número especificado de caras, o 6 por defecto."
    )
  ...
  async execute(interaction) {
    ...
    if (interaction.options.getInteger("caras")) {
      ...
      if (sides <= 0) {
        return interaction.reply({
          content: "Debes proporcionar un número mayor a 0.",
          ephemeral: true,
        });
      }
    }
    ...
    const embed = new EmbedBuilder()
      ...
      .setTitle("Resultado")
      .setDescription(
        `🎲 Has lanzado un dado de **${sides}** caras y ha salido: **${rollResult}**`
      );
